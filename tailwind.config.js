  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-blue': "radial-gradient(at 20% 20%, rgba(37,99,235,0.25) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(6,182,212,0.25) 0px, transparent 50%), radial-gradient(at 0% 80%, rgba(37,99,235,0.18) 0px, transparent 50%), radial-gradient(at 80% 80%, rgba(6,182,212,0.18) 0px, transparent 50%)",
      },
      animation: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 18px 40px -12px rgba(37, 99, 235, 0.25)',
      },
    },
  },
  plugins: [],
